...
Page({
  ...
  async getSuggest(keywords) {
    let suggest = await request('/search/suggest', { keywords:keywords, type: 'mobile' })
  ...
  toSongDetail(e) {
    wx.navigateTo({
      url: '/pages/songDetail/songDetail?musicId=' + e.currentTarget.dataset.musicid + '&type=searchList',
    });
  },
